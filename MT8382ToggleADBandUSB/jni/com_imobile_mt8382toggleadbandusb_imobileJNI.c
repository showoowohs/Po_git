#include "com_imobile_mt8382toggleadbandusb_imobileJNI.h"
...
JNIEXPORT jstring JNICALL Java_com_imobile_mt8382toggleadbandusb_imobileJNI_ReadProc(JNIEnv *env, jclass arg,  jstring str)
{
...
//	}
	...
	if((strcmp(test, "USB") == 0) || strcmp(test, "OTG") == 0){
		p = test;
	}else{
		p = "xx";
	}
...
JNIEXPORT jstring JNICALL Java_com_imobile_mt8382toggleadbandusb_imobileJNI_WriteProc(JNIEnv *env, jclass arg, jstring Write_Path_from_JNI, jstring Write_value_from_JNI)
{
