#include "com_imobile_mt8382readkeyevent_imobileJNI.h"
...
JNIEXPORT jstring JNICALL Java_com_imobile_mt8382readkeyevent_imobileJNI_ReadProc(JNIEnv *env, jclass arg,  jstring str)
{
...
JNIEXPORT jstring JNICALL Java_com_imobile_mt8382readkeyevent_imobileJNI_WriteProc(JNIEnv *env, jclass arg, jstring Write_Path_from_JNI, jstring Write_value_from_JNI)
{
